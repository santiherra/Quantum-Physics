...
n = 2#int(input('Energy level (n): '))
l = 1#int(input('Orbital angular momentum (l): '))
m = 0#int(input('Spin (m): '))
...
ax1.set_title('Orbitals projection')
...
fig.suptitle('HYDROGEN ATOM WAVEFUNCTIONS', fontweight='bold')
fig.text(.65, .95, r'$n = $' + str(n) + r', $l = $' + str(l) + ', $m = $' + str(m), style='italic', fontsize=10, bbox=dict(boxstyle='square', facecolor='none')) 
plt.show()
